...
export const FEATURED_AREAS: Record<RedArea, Area> = {
  ...
  science: { name: 'Ciencia', icon: 'red-paz', color: '#E2596B' },
  art: { name: 'Arte', icon: 'red-paz', color: '#EFB96D' },
  health: { name: 'Salud', icon: 'red-paz', color: '#5DA0B5' },
  territory: { name: 'Territorio', icon: 'red-paz', color: '#B8CF76' },
  victims: { name: 'Víctimas', icon: 'red-paz', color: '#4F4661' },
  agreements: { name: 'Acuerdos', icon: 'red-paz', color: '#50AE98' },
  citizenship: { name: 'Ciudadanía', icon: 'red-paz', color: '#E26F60' },
}
