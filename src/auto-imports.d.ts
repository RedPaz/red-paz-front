...
export {}
declare global {
  const ENEP_PAPERS: typeof import('./common/constants/enepPapers')['ENEP_PAPERS']
  ...
  const RED_PAZ_INITIATIVES: typeof import('./common/constants/redPazInitiatives')['RED_PAZ_INITIATIVES']
  const RED_PAZ_POSTS: typeof import('./common/constants/redPazPosts')['RED_PAZ_POSTS']
